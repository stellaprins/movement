...
def _validate_reference_vector(  # noqa: C90
    ...
    if isinstance(reference_vector, xr.DataArray):
        ...
        if "time" in reference_vector.dims and len(
        ...
        if (reference_vector.dtype != int) or (
        ...
        if reference_vector.shape[-1] != 2:  # Validate space dimension
            raise log_error(
                ValueError,
